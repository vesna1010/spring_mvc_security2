...
public class StudyProgramControllerTest extends BaseControllerTest {
	...
	public void saveStudyProgramAndRenderStudyProgramFormTest_ValidForm() throws Exception {
		...
		mockMvc.perform(
    post("/studyPrograms/save").with(csrf())
				.param("id", "SP1")
				.param("title", "Study Program 1")
	...
	public void renderFormWithStudyProgram_Enabled() throws Exception {
	...
	public void deleteStudyProgramAndRenderStudyProgramsPage_Enabled() throws Exception {
	...
	public void deleteStudyProgramAndRenderStudyProgramsPage_Disabled() throws Exception {
	    mockMvc.perform(get("/studyPrograms/delete/" + "SP1"))
	           .andExpect(status().isForbidden())
               .andExpect(forwardedUrl("/denied")); 
	}
