...
public abstract class BaseTest {
	...
	protected final Student student1 = new Student("S1", "First Student", "First Father Name",
			...
			new Address("City", "Street", "State"), new GregorianCalendar(2017, Calendar.JANUARY, 1).getTime(),
			1, studyProgram1);
	...
	protected final Exam exam1 = new Exam("E1", student1, professor1, subject1,  
			new GregorianCalendar(2017, Calendar.MAY, 1).getTime(), 8);
	protected final Exam exam2 = new Exam("E2", student1, professor2, subject2,
			new GregorianCalendar(2017, Calendar.MAY, 2).getTime(), 9);
	protected final Exam exam3 = new Exam("E3", student2, professor1, subject2, 
			new GregorianCalendar(2017, Calendar.MAY, 3).getTime(), 9);
